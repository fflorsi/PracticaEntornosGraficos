        ...
        <fieldset>
            <legend class="prod"><strong>Finalizar la Compra</strong> <a href="#"
                    onClick="javascript:window.open('https://www.paypal.com/cgibin/webscr?cmd=xpt/popup/OLCWhatIsPayPal-outside','olcwhatispaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, width=400, height=350');"><img
                        src="https://www.paypal.com/en_US/i/bnr/horizontal_solution_PP.gif" alt="Solution Graphics" border="0"
                        align="absmiddle"></a></legend>
                ...
                <tr>
                    <td align="left" valign="top"><span class="prod"><strong>Detalle de los Productos
                        ...
                        <span class="texto1negro"> </span><span class="prod"><strong>Productos:</strong>
                            ...
                            <strong>Precio Total:</strong> $<?php echo number_format($_GET['costo'], 2) ?>
                        </span></td>
                </tr>
            </table>
